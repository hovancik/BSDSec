...
App does receive emails (with [Griddler](https://github.com/thoughtbot/griddler) and [Mailgun](https://mailgun.com), then save it as Article and Tweet about it (with [Twitter](https://github.com/sferik/twitter) gem) and posts to [Reddit](https://reddit.com/r/bsdsec) via [RedditKit](https://github.com/samsymons/RedditKit.rb):
* FreeBSD
* OpenBSD
* NetBSD
...
Right now BSDSec runs on develop branch.
